        ...
        <Element name='pricing'>
            <div className='container'>
                <div className='max-w-full pricing-head_before relative mx-auto border-l border-r border-s2 bg-s1/50 pb-40 pt-28 max-xl:max-w-4xl max-lg:border-none max-md:pb-32 max-md:pt-16'>
                    <h3 className='h3 max-lg:h4 max-md:h-5 z-3 relative mx-auto mb-14 max-w-lg text-center text-p4 max-md:mb-40 max-sm:max-w-sm'>Flexible pricing for teams of all sizes</h3>
                ...
                <div className='scroll-hide relative z-2 -mt-12 flex items-start max-xl:gap-5 max-xl:overflow-auto max-xl:pt-6 '>
                    {plans.map((plan, index) => (
                        ...
                        <div key={plan.id} className='pricing-plan_first pricing-plan_last pricing-plan_odd pricing-plan_even relative border-2 p-7 max-xl:min-w-80 max-lg:rounded-3xl xl:w-[calc(33.33%+2px)]'>
                            {index === 1 && <div className='g4 absolute h-330 left-0 right-0 top-0 z-1 rounded-tl-3xl rounded-tr-3xl'></div>}
